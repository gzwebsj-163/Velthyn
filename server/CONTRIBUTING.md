# Contributing to Mocode_Chat

Thanks for taking the time to contribute! 🎉 Mocode_Chat is built by a global
...
See the [Install from Source](https://docs.Mocode_Chat.ai/guide/manual-install)
guide. In short:
...
Be respectful and constructive. We want Mocode_Chat to be a welcoming place for
everyone.
