...
class AgentInitializer:
    ...
    def initialize_agent(self, session_id = None):
        """
        ...
        # Create agent
        agent = self.agent_bridge.create_agent( system_prompt=system_prompt, tools=tools, max_steps=max_steps, output_mode="logger", workspace_dir=workspace_root, skill_manager=skill_manager, enable_skills=True, max_context_tokens=max_context_tokens, runtime_info=runtime_info   )
        ...
        # Restore persisted conversation history for self session
        if session_id:
    ...
    def _restore_conversation_history(self, agent, session_id):
        """
    ...
    def _setup_memory_system(self, workspace_root, session_id = None):
        """
        Setup memory system
        ...
        try:
            ...
            # Keeps ConversationStore/evolution on the same workspace as self
            ...
            embedding_provider = self._init_embedding_provider( memory_config, session_id=session_id )
    ...
    def _init_embedding_provider(self, memory_config, session_id = None):
        """
    ...
    def _load_tools(self, workspace_root, memory_manager, memory_tools, session_id = None):
        """Load all tools"""
    ...
    def _initialize_scheduler(self, tools, session_id = None):
    ...
    def _initialize_skill_manager(self, workspace_root, session_id = None):
        """Initialize skill manager"""
        try:
    ...
    def _get_runtime_info(self, workspace_root):
