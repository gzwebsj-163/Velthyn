...
class Bridge(object):
    def __init__(self):
        self.btype = { "chat": const.OPENAI,   "voice_to_text": conf().get("voice_to_text") or self._auto_pick_voice_to_text(), "text_to_voice": conf().get("text_to_voice", "google"), "translate": conf().get("translate", "baidu"), }
        # 这边取配置的模型
    ...
    def fetch_translate(self, text, from_lang="", to_lang="en"):
    ...
    def fetch_agent_reply(self, query, context = None, on_event=None, clear_history = False):
        """
