...
class DiscordChannel(ChatChannel):
    ...
    async def _on_message(self, message):
        ...
        try:
            ...
            dc_msg = DiscordMessage( message, is_group=is_group, bot_user_id=self.bot_user_id, ctype=ctype, content=content, )
            ...
            context = self._compose_context( dc_msg.ctype, dc_msg.content, isgroup=is_group, msg=dc_msg,  no_need_at=True, )
            if context:
    ...
    async def _do_cancel(self, session_id, message):
    ...
    async def _download_attachment(self, attachment, name):
    ...
    def _should_reply_in_guild(self, message):
    ...
    @staticmethod
    def _compute_session_id(message, is_group):
    ...
    async def _async_send(self, reply, channel_id):
        try:
            import discord
