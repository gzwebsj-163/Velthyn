...
class WeixinMessage(ChatMessage):
    ...
    def __init__(self, msg, cdn_base_url = CDN_BASE_URL):
        super().__init__(msg)
    ...
    def _setup_media(self, item, media_type, cdn_base_url):
    ...
    def _download_media(self, item, media_type, cdn_base_url):
