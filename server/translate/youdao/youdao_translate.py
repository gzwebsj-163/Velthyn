...
class YoudaoTranslator(Translator):
    ...
    def translate(self, query, from_lang = "", to_lang = "en"):
        ...
        payload = { "q": query, "from": from_lang_code, "to": to_lang_code, "appKey": self.app_key, "salt": salt, "sign": sign, "signType": "v3", "curtime": curtime, }
    ...
    def _build_sign(self, query, salt, curtime):
        """
