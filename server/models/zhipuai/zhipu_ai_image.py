...
class ZhipuAIImage(object):
    ...
    def create_img(self, query, retry_count=0, api_key=None, api_base=None):
        try:
            ...
            response = self.client.images.generations( prompt=query, n=1,   model=conf().get("text_to_image") or "cogview-3", size=conf().get("image_create_size", "1024x1024"),   quality="standard", )
