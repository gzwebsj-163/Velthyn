...
class OpenAIImage(object):
    def __init__(self):
        ...
        self._image_client = OpenAIHTTPClient( api_key=self._image_api_key, api_base=self._image_api_base, proxy=self._image_proxy, )
    ...
    def create_img(self, query, retry_count=0, api_key=None, api_base=None):
        try:
            ...
            response = self._image_client.images_generate( api_key=api_key or None, api_base=api_base or None, prompt=query,   n=1, model=conf().get("text_to_image") or "dall-e-2",  )
