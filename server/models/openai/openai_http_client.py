...
def _resolve_attribution_headers(url):
    try:
...
class OpenAIHTTPClient:
    ...
    def __init__(self, api_key = None, api_base = None, proxy = None, timeout = None, extra_headers = None):
    ...
    def chat_completions(self, *, api_key = None, api_base = None, timeout = None, proxy = None, extra_headers = None, extra_query = None, path = "/chat/completions", stream = False, **payload):
        ...
        return self._request( path=path, payload=payload, api_key=api_key, api_base=api_base, timeout=timeout, proxy=proxy, extra_headers=extra_headers, extra_query=extra_query, stream=stream, )

    def completions(self, *, api_key = None, api_base = None, timeout = None, **payload):
        """POST /completions (legacy text completion). Non-streaming only."""
        payload.pop("stream", None)
        return self._request( path="/completions", payload=payload, api_key=api_key, api_base=api_base, timeout=timeout, stream=False, )

    def images_generate(self, *, api_key = None, api_base = None, timeout = None, **payload):
        """POST /images/generations."""
        return self._request( path="/images/generations", payload=payload, api_key=api_key, api_base=api_base, timeout=timeout, stream=False, )
    ...
    def _request(self, *, path, payload, api_key, api_base, timeout, stream, proxy = None, extra_headers = None, extra_query = None):
        ...
        if stream:
            ...
            return self._stream_chat( url=url, headers=headers, payload=clean_payload, proxies=proxies, timeout=req_timeout, params=extra_query, )
    ...
    def _stream_chat(self, *, url, headers, payload, proxies, timeout, params = None):
    ...
    @staticmethod
    def _make_error_chunk(status_code, message):
...
def get_default_client(api_key = None, api_base = None, proxy = None, timeout = None):
