...
def resolve_custom_credentials():
    ...
    if not is_custom:
        ...
        return ( conf().get("open_ai_api_key", ""), conf().get("open_ai_api_base") or None, None, )
    ...
    if provider_id:
        ...
        if provider is not None:
            return ( provider.get("api_key", ""), provider.get("api_base") or None, provider.get("model") or None, )
    ...
    return ( conf().get("custom_api_key", ""), conf().get("custom_api_base") or None, None, )