...
class ClaudeAPIBot(Bot, OpenAIImage):
    ...
    def reply_text(self, session, retry_count=0, tools=None):
        try:
            ...
            data = { "model": actual_model, "messages": claude_messages, "max_tokens": self._get_max_tokens(actual_model) }
    ...
    def call_with_tools(self, messages, tools=None, stream=False, **kwargs):
        ...
        request_params = { "model": actual_model, "max_tokens": kwargs.get("max_tokens", self._get_max_tokens(actual_model)), "messages": claude_messages, "stream": stream }
                        ...
                        try:
                            ...
                            if event_type == "content_block_start":
                                ...
                                if delta_type == "thinking_delta":
                                    ...
                                    if thinking_text:
                                        yield { "choices": [{ "index": 0, "delta": { "role": "assistant", "reasoning_content": thinking_text }, "finish_reason": None }] }

                                elif delta_type == "text_delta":
                                    content = delta.get("text", "")
                                    yield { "id": event.get("id", ""), "object": "chat.completion.chunk", "created": int(time.time()), "model": request_params["model"], "choices": [{ "index": 0, "delta": {"content": content}, "finish_reason": None }] }
