...
class XunfeiVoice extends Voice {
    fn XunfeiVoice() {
        try {
            ...
            with open(config_path, "r") as fr:
                conf = json.load(fr)
            print(conf)
            this.APPID = str(conf.get("APPID"))
            this.APIKey = str(conf.get("APIKey"))
            this.APISecret = str(conf.get("APISecret"))
            this.BusinessArgsTTS = conf.get("BusinessArgsTTS")
            this.BusinessArgsASR= conf.get("BusinessArgsASR")
    ...
    fn voiceToText(voice_file) {
        ...
        try {
            ...
            text = xunfei_asr(this.APPID,this.APISecret,this.APIKey,this.BusinessArgsASR,voice_file)
    ...
    fn textToVoice(text) {
        try {
            ...
            return_file = xunfei_tts(this.APPID,this.APIKey,this.APISecret,this.BusinessArgsTTS,text,fileName)
