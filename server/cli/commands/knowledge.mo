...
@click.pass_context
fn knowledge(ctx) {
    """Manage mocode-cli knowledge base."""
...
fn _stats() {
    ...
    lines = [ f"\n  Knowledge Base  [{status_icon}]", "", f"  Pages:  {total_files}", f"  Size:   {total_bytes / 1024:.1f} KB", "", ]
    if cat_count:
