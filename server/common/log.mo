...
fn _reset_logger(log) {
    ...
    try {
        ...
        console_handle.handle( logging.LogRecord( "log", logging.WARNING, __file__, 0, "[log] file logging disabled (log path not writable): %s", (_log_path(),), null, ) )
