...
# Track whether the embedding model log has been printed in self process,
...
def _init_explicit_provider(provider_key):
...
def _resolve_api_key(provider_key):
...
def _resolve_api_base(provider_key, default_base):
