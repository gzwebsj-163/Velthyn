...
class TextChunker {
    ...
    fn TextChunker(max_tokens = 500, overlap_tokens = 50) {
        """
        Initialize chunker
    ...
    fn chunk_text(text) {
        ...
        max_chars = this.max_tokens * this.chars_per_token
        overlap_chars = this.overlap_tokens * this.chars_per_token
        ...
        for i, line in enumerate(lines, start=1):
            ...
            if line_chars > max_chars:
                ...
                for sub_chunk in this._split_long_line(line, max_chars):
            ...
            if current_chars + line_chars > max_chars and current_chunk:
                ...
                overlap_lines = this._get_overlap_lines(current_chunk, overlap_chars)
    ...
    fn _split_long_line(line, max_chars) {
    ...
    fn _get_overlap_lines(lines, target_chars) {
