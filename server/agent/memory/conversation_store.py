...
def _is_visible_user_message(content):
    """
...
def _extract_display_text(content):
    """
...
def _is_internal_user_marker(text):
...
def _group_into_display_turns(rows, include_thinking = True):
    """
...
class ConversationStore:
    ...
    def load_messages(self, session_id, max_turns = 30):
        """
    ...
    def get_context_start_seq(self, session_id):
    ...
    def get_latest_pair_seqs(self, session_id):
    ...
    def delete_message_pair(self, session_id, user_seq, delete_user = True, cascade = False):
    ...
    def prune_scheduled_messages(self, session_id, keep_last_n, markers = None):
        """
        ...
        def _matches_marker(raw_content):
            try:
    ...
    def cleanup_old_sessions(self, max_age_days = None):
        """
    ...
    def attach_extras_to_last_assistant(self, session_id, extras):
        """
    ...
    def load_history_page(self, session_id, page = 1, page_size = 20):
        """
