...
class MemoryService:
    ...
    # ------------------------------------------------------------------
    def list_files(self, page = 1, page_size = 20, category = "memory"):
        """
    ...
    def _list_evolution_files(self):
    ...
    # ------------------------------------------------------------------
    def get_content(self, filename, category = "memory"):
        """
    ...
    # internal helpers
    # ------------------------------------------------------------------
    def _resolve_path(self, filename, category = "memory"):
        """
    ...
    @staticmethod
    def _file_info(path, filename, file_type):
