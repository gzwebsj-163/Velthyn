...
def _repair_tool_use_adjacency(messages):
    """
...
def drop_orphaned_tool_results_openai(messages):
    """
...
def compress_turn_to_text_only(turn):
    """
...
def identify_complete_turns(messages):
...
def build_compaction_summary_text(summary, turn_count, original_text = ""):
...
def find_first_user_text_block(turns):
