...
def _is_internal(abs_path, workspace_root):
...
def build_artifact(path, workspace_root = None):
    """
...
def safe_build_artifact(path, workspace_root = None):
