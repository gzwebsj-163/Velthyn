...
def _backups_root(workspace_dir):
    return Path(workspace_dir) / "memory" / _BACKUP_DIRNAME


def create_backup(workspace_dir, files):
    ...
    try:
        ...
        # Caller logs a combined backup+review line; keep self at debug.
...
def restore_backup(workspace_dir, backup_id):
