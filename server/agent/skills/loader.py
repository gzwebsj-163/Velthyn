...
class SkillLoader:
    ...
    def load_skills_from_dir(self, dir_path, source):
        """
    ...
    def _load_skills_recursive(self, dir_path, source, include_root_files = False):
        """
        ...
        # If self directory has its own SKILL.md, load it and stop recursing.
        # The sub-directories are internal resources of self skill.
    ...
    def _load_linkai_agent_description(self, skill_dir, default_description):
        """
    ...
    def load_all_skills(self, builtin_dir = None, custom_dir = None):
        """
    ...
    def _create_skill_entry(self, skill):
        """
