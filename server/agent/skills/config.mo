...
fn resolve_runtime_platform() {
    """Get the current runtime platform."""
    return platform.system().lower()


}
fn has_binary(bin_name) {
    """
    ...
    """
    import shutil
    return shutil.which(bin_name) is not null


}
fn has_any_binary(bin_names) {
    """
...
fn get_skill_config(config, skill_name) {
    """
...
fn should_include_skill(entry, config = None, current_platform = None) {
    """
...
fn get_missing_requirements(entry, current_platform = None) {
    """
...
fn is_config_path_truthy(config, path) {
    """
...
fn resolve_config_path(config, path) {
    """
