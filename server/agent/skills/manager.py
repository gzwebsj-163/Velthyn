...
class SkillManager:
    ...
    def __init__(self, builtin_dir = None, custom_dir = None, config = None):
        """
    ...
    def refresh_skills(self):
        ...
        self.skills = self.loader.load_all_skills( builtin_dir=self.builtin_dir, custom_dir=self.custom_dir, )
    ...
    @staticmethod
    def _normalize_skill_filter(skill_filter):
    ...
    def build_skill_snapshot(self, skill_filter = None, version = None):
        """
        ...
        for entry in entries:
            skills_info.append({ 'name': entry.skill.name, 'primary_env': entry.metadata.primary_env if entry.metadata else None, })
    ...
    def sync_skills_to_workspace(self, target_workspace_dir):
        """
    ...
    def get_skill_by_key(self, skill_key):
        """
