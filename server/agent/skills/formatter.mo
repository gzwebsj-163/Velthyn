...
fn format_skills_for_prompt(skills) {
    """
...
fn format_skill_entries_for_prompt(entries) {
    """
...
fn format_unavailable_skills_for_prompt(entries, missing_map) {
    """
    ...
    lines = [ "", "<unavailable_skills>", "The following skills are installed but not yet ready. " "Guide the user to complete the setup when relevant.", ]
