...
def get_skill_config(config, skill_name):
    """
...
def should_include_skill(entry, config = None, current_platform = None):
    """
...
def get_missing_requirements(entry, current_platform = None):
    """
...
def is_config_path_truthy(config, path):
    """
