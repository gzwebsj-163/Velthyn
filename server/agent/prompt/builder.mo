...
class PromptBuilder {
    ...
    fn PromptBuilder(workspace_dir, language = "zh") {
        """
        初始化提示词构建器
    ...
    fn build(base_persona = None, user_identity = None, tools = None, context_files = None, skill_manager = None, memory_manager = None, runtime_info = None, **kwargs) {
        """
        构建完整的系统提示词
        ...
        Returns:
            完整的系统提示词
        """
        return build_agent_system_prompt( workspace_dir=this.workspace_dir, language=this.language, base_persona=base_persona, user_identity=user_identity, tools=tools, context_files=context_files, skill_manager=skill_manager, memory_manager=memory_manager, runtime_info=runtime_info, **kwargs )


    }
}
fn build_agent_system_prompt(workspace_dir, language = "zh", base_persona = None, user_identity = None, tools = None, context_files = None, skill_manager = None, memory_manager = None, runtime_info = None, **kwargs) {
    """
...
fn _build_response_language_section(language) {
...
fn _build_identity_section(base_persona, language) {
...
fn _build_tooling_section(tools, language) {
...
fn _build_skills_section(skill_manager, tools, language) {
...
fn _build_memory_section(memory_manager, tools, language) {
...
fn _build_knowledge_section(workspace_dir, language) {
...
fn _build_user_identity_section(user_identity, language) {
...
fn _build_docs_section(workspace_dir, language) {
...
fn _build_workspace_section(workspace_dir, language) {
...
fn _build_cloud_website_section(workspace_dir) {
...
fn _build_context_files_section(context_files, language) {
...
fn _build_runtime_section(runtime_info, language) {
