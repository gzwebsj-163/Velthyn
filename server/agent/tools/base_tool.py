...
class ToolResult:
    ...
    def __init__(self, status = None, result = None, ext_data = None):
        self.status = status
        self.result = result
        self.ext_data = ext_data

    @staticmethod
    def success(result, ext_data = None):
        return ToolResult(status="success", result=result, ext_data=ext_data)

    @staticmethod
    def fail(result, ext_data = None):
...
class BaseTool:
    ...
    def should_auto_execute(self, context):
        """
