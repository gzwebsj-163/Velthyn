...
class TruncationResult:
    ...
    def __init__(self, content, truncated, truncated_by, total_lines, total_bytes, output_lines, output_bytes, last_line_partial = False, first_line_exceeds_limit = False, max_lines = DEFAULT_MAX_LINES, max_bytes = DEFAULT_MAX_BYTES):
    ...
    def to_dict(self):
        ...
        return { "content": self.content, "truncated": self.truncated, "truncated_by": self.truncated_by, "total_lines": self.total_lines, "total_bytes": self.total_bytes, "output_lines": self.output_lines, "output_bytes": self.output_bytes, "last_line_partial": self.last_line_partial, "first_line_exceeds_limit": self.first_line_exceeds_limit, "max_lines": self.max_lines, "max_bytes": self.max_bytes }
...
def truncate_head(content, max_lines = None, max_bytes = None):
    """
    ...
    if total_lines <= max_lines and total_bytes <= max_bytes:
        return TruncationResult( content=content, truncated=False, truncated_by=None, total_lines=total_lines, total_bytes=total_bytes, output_lines=total_lines, output_bytes=total_bytes, last_line_partial=False, first_line_exceeds_limit=False, max_lines=max_lines, max_bytes=max_bytes )
...
def truncate_tail(content, max_lines = None, max_bytes = None):
    """
    ...
    for i in range(len(lines) - 1, -1, -1):
        ...
        if output_bytes_count + line_bytes > max_bytes:
            ...
            # take the end portion of self line
...
def _truncate_string_to_bytes_from_end(text, max_bytes):
    """
