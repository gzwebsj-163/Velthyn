...
fn assert_public_ip(ip_str) {
    ...
    if _is_blocked_ip(ip):
        raise ValueError( f"URL resolves to a non-public address ({ip_str}), " f"request blocked for security" )


}
fn validate_url_safe(url) {
