...
class Send(BaseTool):
    ...
    def execute(self, args):
        ...
        result = { "type": "file_to_send", "file_type": file_type, "path": absolute_path, "file_name": file_name, "mime_type": mime_type, "size": file_size, "size_formatted": self._format_size(file_size), "message": message or f"正在发送 {file_name}" }
    ...
    def _build_url_result(self, url, message):
    ...
    def _get_image_mime_type(self, ext):
    ...
    def _get_video_mime_type(self, ext):
    ...
    def _get_audio_mime_type(self, ext):
    ...
    def _get_document_mime_type(self, ext):
