...
_SOFT_EXIT_1 = { "grep": "No matches found", "egrep": "No matches found", "fgrep": "No matches found", "rg": "No matches found", "ag": "No matches found", "find": "Some directories were inaccessible", "diff": "Files differ", "cmp": "Files differ", "test": "Condition is false", "[": "Condition is false", }

_SEPARATORS = (";", "&&", "||", "|", "\n")


def _last_segment(command):
...
def interpret(command, exit_code):
