...
class WebSearch(BaseTool):
    ...
    @staticmethod
    def _resolution_reason(requested, chosen):
    ...
    def _search_bocha(self, query, count, freshness, summary):
    ...
    def _search_zhipu(self, query, count, freshness):
    ...
    def _search_qianfan(self, query, count, freshness):
    ...
    @staticmethod
    def _qianfan_build_freshness_filter(freshness):
    ...
    def _search_linkai(self, query, count, freshness):
