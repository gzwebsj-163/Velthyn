...
class SchedulerTool(BaseTool):
    ...
    def _create_task(self, **kwargs):
        ...
        if message:
            action = { "type": "send_message", "content": message, "receiver": context.get("receiver"), "receiver_name": self._get_receiver_name(context), "is_group": context.get("isgroup", False), "channel_type": self.config.get("channel_type", "unknown"), "notify_session_id": notify_session_id, }
        else:  # ai_task
            action = { "type": "agent_task", "task_description": ai_task, "receiver": context.get("receiver"), "receiver_name": self._get_receiver_name(context), "is_group": context.get("isgroup", False), "channel_type": self.config.get("channel_type", "unknown"), "notify_session_id": notify_session_id, }
    ...
    def _parse_schedule(self, schedule_type, schedule_value):
    ...
    def _format_schedule_description(self, schedule):
    ...
    def _get_receiver_name(self, context):
