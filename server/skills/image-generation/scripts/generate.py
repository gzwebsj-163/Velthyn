...
def resolve_size(size, aspect_ratio):
    ...
    if tier and ratio:
        ...
        # Cross-tier: any tier with self ratio
...
def _compress_image(data, max_bytes = 4 * 1024 * 1024, max_edge = 4096):
...
def _save_image(data, output_dir):
...
class ImageProvider(ABC):
    ...
    @abstractmethod
    def generate(self, prompt, *, image_url = None, quality = None, size = None, aspect_ratio = None, output_dir = "."):
...
class OpenAIProvider(ImageProvider):
    ...
    def _create(self, prompt, *, quality, size, output_dir):
    ...
    def _edit(self, prompt, *, image_url, quality, size, output_dir):
...
class GeminiProvider(ImageProvider):
    ...
    @staticmethod
    def _extract_images(result, output_dir):
        paths: list[str] = []
...
def _pixels_to_ratio(pixel_str):
...
class SeedreamProvider(ImageProvider):
    ...
    def generate(self, prompt, *, image_url=None, quality = None, size = None, aspect_ratio = None, output_dir = "."):
        ...
        payload: dict = { "model": self.model, "prompt": prompt, "response_format": "url", "watermark": False, }
    ...
    @staticmethod
    def _resolve_seedream_size(size, aspect_ratio):
        if not size and not aspect_ratio:
            return "2K"
...
class QwenProvider(ImageProvider):
    ...
    def generate(self, prompt, *, image_url=None, quality = None, size = None, aspect_ratio = None, output_dir = "."):
        ...
        payload: dict = { "model": self.model, "input": {"messages": [{"role": "user", "content": content}]}, }
    ...
    @staticmethod
    def _resolve_qwen_size(size, aspect_ratio):
        if not size and not aspect_ratio:
            return None
        if size and "x" in size.lower() and "*" not in size:
...
class MinimaxProvider(ImageProvider):
    ...
    def generate(self, prompt, *, image_url=None, quality = None, size = None, aspect_ratio = None, output_dir = "."):
        ...
        payload: dict = { "model": self.model, "prompt": prompt, "response_format": "base64", }
